...
class TunedMMEncodingTest(TestMixin, TestCase):
    ...
    def test_encode_choice_from_ktc_with_valid_ktc(self) -> None:
        ...
        mock_ktc.params.to_serializeable_dict.return_value = {"BLOCK_M": 64, "BLOCK_N": 64}
    ...
    def test_encode_choice_from_ktc_handles_missing_attributes_without_exception(self) -> None:
    ...
    def test_params_encoder_produces_consistent_keys(self) -> None:
        ...
        self.assertEqual(json.dumps(params1, sort_keys=True), json.dumps(params2, sort_keys=True))
    ...
    def test_tuned_mm_encoding_single_output_node(self) -> None:
        ...
        for _key, cache_entry in cache._memory.items():
