...
def _encode_multi_template_buffer(
    ...
    deferred_holder: list[DeferredRecording[TensorBox, TunedKernelEncodedResult] | None] = [deferred]
    ...
    cached_timings_by_hash: dict[object, float] | None = None
                ...
                def mapped_choice_timings(
                    ...
                    if cached_timings_by_hash is not None:
                        ...
                        all_choices_cached = all(
                            ...
                            for choice in new_timings.keys()
                        )
...
def tuned_int_mm_params_encoder(
    ...
    *,
    ...
    # Create MMKernelInputs with the realized matrices
    kernel_inputs = MMKernelInputs([mat1_realized, mat2_realized], out_dtype=torch.int32)
...
def tuned_scaled_mm_params_encoder(
    ...
    if not bias:
        ...
        input_nodes = [mat_a_realized, mat_b_realized, scale_a_real, scale_b_real, bias_real]
